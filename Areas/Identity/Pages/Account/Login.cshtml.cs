...
namespace NETweet.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<NETUser> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Regex.IsMatch(Input.User, @"^[^@\s]+@[^@\s]+\.[^@\s]+$"))
                {
                    NETUser identityUser = await _userManager.FindByEmailAsync(Input.User);
                    Input.User = identityUser.UserName;
                }
