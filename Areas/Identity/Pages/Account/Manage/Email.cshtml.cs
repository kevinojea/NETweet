...
namespace NETweet.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        private async Task LoadAsync(NETUser user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            var email = await _userManager.GetEmailAsync(user);
            var emailused = await _userManager.FindByEmailAsync(Input.NewEmail);

            if ((Input.NewEmail != email) && (emailused == null))
            {
